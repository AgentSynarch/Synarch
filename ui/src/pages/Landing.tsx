...
const TerminalAnimation: React.FC = () => {
  ...
  return (
    <div ref={sectionRef} className="rounded-xl border border-neutral-200 bg-neutral-900 overflow-hidden shadow-2xl">
      ...
      <div ref={containerRef} className="p-5 space-y-0.5 h-[380px] overflow-y-auto" style={{ scrollbarWidth: "none" }}>
        {lines.map((line, i) => (
          <div key={i} className={`font-mono text-[12px] leading-[1.8] ${line.s}`}>
            {line.c || "\u00A0"}
          </div>
        ))}
...
const Landing: React.FC = () => {
  return (
    <div className="bg-white text-neutral-900" style={{ fontFamily: "'Inter', sans-serif" }}>
      {/* ═══ NAV ═══ */}
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-neutral-100">
        <div className="mx-auto max-w-6xl px-6 flex items-center justify-between h-14">
          <div className="flex items-center gap-8">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 text-sm text-neutral-500 hover:text-neutral-800 transition-colors">
          ...
          <Link to="/" className="flex items-center gap-2">
            <img src={logo} alt="Synarch" className="w-5 h-5 object-contain" />
            <span className="font-semibold text-sm">Synarch</span>
          </Link>
      ...
      <section className="relative pt-14">
        ...
        <div className="relative -mt-32 text-center px-6 pb-24">
          ...
          <p className="text-lg text-neutral-400 max-w-md mx-auto mb-10">
            Deploy AI agents, configure networks, automate tasks and<br />your infrastructure runs itself.
          </p>
          <div className="flex items-center justify-center gap-4">
            ...
            <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="bg-white hover:bg-neutral-50 text-neutral-700 border border-neutral-200 px-7 py-3 rounded-full text-sm font-medium transition-colors flex items-center gap-2">
              GitHub
        ...
        <Reveal delay={200}>
          <div className="bg-neutral-50 border border-neutral-100 rounded-2xl p-8">
            ...
            {[
              ...
              <div key={agent.name} className="flex items-center gap-4 mb-4 last:mb-0">
                ...
                <div className="flex-1 flex gap-1">
                  {agent.tasks.map((task, i) => (
                    <div key={i} className="flex-1 bg-sky-100 text-sky-700 text-[10px] px-2 py-1.5 rounded text-center truncate">{task}</div>
                  ))}
                </div>
              </div>
            ))}
      ...
      <section className="mx-auto max-w-4xl px-6 py-32">
        ...
        <Reveal delay={200}>
          <p className="text-center text-[14px] text-neutral-400 mt-8">
            Open source. Self-hosted. Interactive setup walks you through installation<br />
            and first network. No account required. No agents installed automatically.
          </p>
        </Reveal>
      </section>
      ...
      <section className="bg-neutral-900 text-white py-24">
        <Reveal>
          <div className="text-center px-6">
            ...
            <div className="flex items-center justify-center gap-4">
              <Link to="/launch" className="bg-white hover:bg-neutral-100 text-neutral-900 px-8 py-3 rounded-full text-sm font-medium transition-colors">
                Launch Agent
              </Link>
              <Link to="/docs" className="border border-neutral-700 hover:border-neutral-500 text-neutral-400 hover:text-white px-8 py-3 rounded-full text-sm font-medium transition-colors">
                Read Docs
              </Link>
            </div>
          </div>
